...
// import {IUniswapV3Pool} from "../../interfaces/common/IUniswapV3Pool.sol";
...
// contract StrategyPassiveManagerUniswap is StratFeeCowManagerInitializable, IStrategyConcLiq, IStrategyUniswapV3 {
//     using SafeERC20Upgradeable for IERC20Upgradeable;
//     // using IERC20MetadataUpgradeable for IERC20Upgradeable;
...
//             minting = true;
//             IUniswapV3Pool(pool).mint(address(this), positionMain.tickLower, positionMain.tickUpper, liquidity, "Vifi Main");
//         }
...
//         if (liquidity > 0) {
//             minting = true;
//             IUniswapV3Pool(pool).mint(address(this), positionAlt.tickLower, positionAlt.tickUpper, liquidity, "Vifi Alt");
//         }
//     }
...
//             uint256 out0;
//             if (lpToken0 != native) out0 = UniswapV3Utils.swap(unirouter, lpToken0ToNativePath, amountToSwap0);
...
//             uint256 out1;
//             if (lpToken1 != native) out1 = UniswapV3Utils.swap(unirouter, lpToken1ToNativePath, amountToSwap1);
...
//         if (_path.length > 0) {
//             (address[] memory _route) = UniswapV3Utils.pathToRoute(_path);
...
//         return UniswapV3Utils.pathToRoute(lpToken0ToNativePath);
//     }
...
//         return UniswapV3Utils.pathToRoute(lpToken1ToNativePath);
//     }
...
//         return IUniV3Quoter(quoter).quoteExactInput(lpToken0ToNativePath, amount) * 10;
//     }
...
//         return IUniV3Quoter(quoter).quoteExactInput(lpToken1ToNativePath, amount) * 10;
//     }

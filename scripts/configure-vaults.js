...
// Factories
const VAULT_V7_FACTORY = "0xffC494f0ED0C4d1ba5B830bcc8CbdC969b36A3Fc";
const VAULT_CLM_FACTORY = "0x2917597659acfB48CB762cc0d1817c28AB614f3b";
...
const REWARD_POOL_FACTORY = "0x0EF66Aad2682c9DfBbCf73ea97752E8d0f4cBCF1";
...
async function main() {
    ...
    const ICHI_SWAPX_STS_USDC_WANT = "0x79cfab400429c81f1656df4d65363cb5fd340509"
    const ICHI_SWAPX_STS_USDC_GAUGE = "0x7791ecc02ce43f877df2d39d8073572ded64617e"
    ...
    const ICHI_SWAPX_ATOLL_ATETH_WANT = "0x1657c5479d73cd6159048ba358b903cc4b94765e"
    const ICHI_SWAPX_ATOLL_ATETH_GAUGE = "0x21b51b78a9a11d77ca06d75e98fa7b45b4ea96fa"
    ...
    const ICHI_SWAPX_WETH_USDC_WANT = "0x048d4f8ddee53dd41c35a1a2a691c0ef91eff3d6"
    const ICHI_SWAPX_WETH_USDC_GAUGE = "0x0e9c8f42349a9eb074605ba175e751bd158c1165"

    const ICHI_SWAPX_ATETH_SCETH_WANT = "0x20737388dbc9f7e56f4cc69d41da62c96b355db0"
    const ICHI_SWAPX_ATETH_SCETH_GAUGE = "0xbbb10f33dcdd50bd4317459a4b051fc319b29585"

    const ICHI_SWAPX_ATETH_ATOLL_WANT = "0x1657c5479d73cd6159048ba358b903cc4b94765e"
    const ICHI_SWAPX_ATETH_ATOLL_GAUGE = "0x21b51b78a9a11d77ca06d75e98fa7b45b4ea96fa"
    ...
    const ICHI_SWAPX_USDC_SCUSD_WANT = "0x776c31466f19d4e2c71bce16c0549a8bc0e37e17"
    const ICHI_SWAPX_USDC_SCUSD_GAUGE = "0x4604782bcd6f749b271fc9d14bfd583be6e5a6cf"
    ...
    // await deploySwapxVault("VIFI SWAPX wS-SWPX", "Vifi wS-SWPX", ICHI_SWAPX_WS_SWPX_WANT, ICHI_SWAPX_WS_SWPX_GAUGE);
    // await deploySwapxVault("VIFI SWAPX wS-USDC", "Vifi wS-USDC", ICHI_SWAPX_WS_USDC_WANT, ICHI_SWAPX_WS_USDC_GAUGE);
    // await deploySwapxVault("VIFI SWAPX stS-USDC", "Vifi stS-USDC", ICHI_SWAPX_STS_USDC_WANT, ICHI_SWAPX_STS_USDC_GAUGE);
    // await deploySwapxVault("VIFI SWAPX SACRA-wS", "Vifi SACRA-wS", ICHI_SWAPX_SACRA_WS_WANT, ICHI_SWAPX_SACRA_WS_GAUGE);
    // await deploySwapxVault("VIFI SWAPX USDC-SWPX", "Vifi USDC-SWPX", ICHI_SWAPX_USDC_SWPX_WANT, ICHI_SWAPX_USDC_SWPX_GAUGE);
    // await deploySwapxVault("VIFI SWAPX ATOLL-atETH", "Vifi ATOLL-atETH", ICHI_SWAPX_ATOLL_ATETH_WANT, ICHI_SWAPX_ATOLL_ATETH_GAUGE);
    // await deploySwapxVault("VIFI SWAPX USDC-wETH", "Vifi USDC-wETH", ICHI_SWAPX_USDC_WETH_WANT, ICHI_SWAPX_USDC_WETH_GAUGE);
    // await deploySwapxVault("VIFI SWAPX wETH-USDC", "Vifi wETH-USDC", ICHI_SWAPX_WETH_USDC_WANT, ICHI_SWAPX_WETH_USDC_GAUGE);
    // await deploySwapxVault("VIFI SWAPX atETH-scETH", "Vifi atETH-scETH", ICHI_SWAPX_ATETH_SCETH_WANT, ICHI_SWAPX_ATETH_SCETH_GAUGE);
    // await deploySwapxVault("VIFI SWAPX atETH-ATOLL", "Vifi atETH-ATOLL", ICHI_SWAPX_ATETH_ATOLL_WANT, ICHI_SWAPX_ATETH_ATOLL_GAUGE);
    // await deploySwapxVault("VIFI SWAPX wS-scETH", "Vifi wS-scETH", ICHI_SWAPX_WS_SCETH_WANT, ICHI_SWAPX_WS_SCETH_GAUGE);
    await deploySwapxVault("VIFI SWAPX USDC-scUSD", "Vifi USDC-scUSD", ICHI_SWAPX_USDC_SCUSD_WANT, ICHI_SWAPX_USDC_SCUSD_GAUGE);
